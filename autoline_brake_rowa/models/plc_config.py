...
class PlcWorkstation(models.Model):
    ...
    def search(self, domain, offset=0, limit=None, order=None):
        ...
        self.env['autoline_brake_rowa.module_expiry'].check_expiry()
    ...
    part_no_rowaa = fields.Char(
        ...
        help="Part number used for QR code generation when Brake-Rowaa variant runs"
    )
    revision_rowaa = fields.Char(
        string='Revision (Brake-Rowaa)',
        size=2,
        help="Revision character for Brake-Rowaa variant"
    )
    vendor_code_rowaa = fields.Char(
        string='Vendor Code (Brake-Rowaa)',
        help="Vendor code used for Brake-Rowaa variant"
    )
    ...
    m_bit_read_method = fields.Selection([
        ...
        help="Method to use for reading M bits. For Mitsubishi FX5U with M0=8192 mapping, use Coils (Function Code 0x01). Default: auto."
    )
