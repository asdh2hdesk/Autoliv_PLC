...
class PlcDashboardController(http.Controller):
    ...
    def print_qr_code(self, cycle_id, **kwargs):
        ...
        try:
            ...
            if not cycle.exists():
                return request.render('autoliv_plc.error_template', {
            ...
            return request.render('autoliv_plc.print_template', {
                'cycle': cycle,
