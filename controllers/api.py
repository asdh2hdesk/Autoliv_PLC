...
class PlcApiController(http.Controller):
    ...
    def scanner_capture_page(self, **kwargs):
        ...
        return request.render('autoliv_plc.scanner_capture_page', {})
    ...
    def process_scan_usb(self, **kwargs):
        ...
        try:
            ...
            if not scanned_data:
                ...
                return request.render('autoliv_plc.scanner_input_page', {})
            ...
            if match_found and cycle:
                ...
                if request.httprequest.headers.get('Accept', '').find('text/html') >= 0:
                    return request.render('autoliv_plc.scanner_result_page', response_data)
            ...
            if request.httprequest.headers.get('Accept', '').find('text/html') >= 0:
                return request.render('autoliv_plc.scanner_result_page', error_response)
